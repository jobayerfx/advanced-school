...
$lang['envato_market_purchase_code_for_smart_school_android_app'] ="Envato Market Κωδικός αγοράς για εφαρμογή Android Model School";
$lang['epf_no'] ="EPF Αρ.";
$lang['error'] ="Λάθος";
...
$lang['latest_app_name_version'] ="Τελευταία έκδοση Model School";
...
$lang['your_app_name_version'] ="Η έκδοση Model School σας";
...
$lang['about']="Για";
$lang['about_me'] ="Σχετικά με εμένα";
$lang['activity']="Δραστηριότητα";
$lang['add_fine'] ="Προσθήκη Fine";
$lang['add_holiday']="Προσθήκη Διακοπών";
$lang['add_holiday_type']="Προσθήκη τύπου διακοπών";
$lang['addons'] ="Πρόσθετα";
$lang['age']="Ηλικία";
$lang['annual_calendar']="Ετήσιο Ημερολόγιο";
$lang['attendance_settings_not_configured'] ="Οι ρυθμίσεις συμμετοχής δεν έχουν διαμορφωθεί";
$lang['available_count'] ="Διαθέσιμος αριθμός";
$lang['build_cv']="Δημιουργία βιογραφικού";
$lang['buy_now'] ="Αγοράστε τώρα";
$lang['calendar_list']="Λίστα ημερολογίου";
$lang['course']="Πορεία";
$lang['cumulative'] ="Σωρευτικός";
$lang['cv_fields']="Πεδία βιογραφικού";
$lang['cv_other_fields']="Βιογραφικό Άλλα πεδία";
$lang['cv_setting']="Ρύθμιση βιογραφικού";
$lang['dashboard_setting']="Ρύθμιση ταμπλό";
$lang['day_wise_with_cron_setting'] ="Day Wise με ρύθμιση Cron";
$lang['download_admit_card_in_student_parent_panel'] ="Κατεβάστε την Κάρτα Εισδοχής στον Πίνακα Φοιτητών / Γονέων";
$lang['download_cv']="Κατεβάστε το βιογραφικό";
$lang['download_resume'] ="Λήψη βιογραφικού";
$lang['edit_holiday']="Επεξεργασία διακοπών";
$lang['edit_holiday_type']="Επεξεργασία τύπου διακοπών";
$lang['education_qalification'] ="Εκπαίδευση/Προσόντα";
$lang['enable_download']="Ενεργοποίηση λήψης";
$lang['entry_from']="Είσοδος από";
$lang['entry_time']="Ώρα εισόδου";
$lang['entry_upto']="Είσοδος μέχρι";
$lang['exit_time']="Ώρα εξόδου";
$lang['expense_money_out'] ="Έξοδος χρημάτων";
$lang['expiry_date'] ="Ημερομηνία λήξης";
$lang['fees_discount_details']="Λεπτομέρειες έκπτωσης τελών";
$lang['file_is_invalid_please_upload_valid_file'] ="Το αρχείο δεν είναι έγκυρο, μεταφορτώστε έγκυρο αρχείο";
$lang['fill_resume_details']="Συμπληρώστε Στοιχεία Βιογραφικού";
$lang['front_site']="Μπροστινή τοποθεσία";
$lang['general_purpose'] ="Γενικού σκοπού";
$lang['holiday']="Αργία";
$lang['holiday_type']="Τύπος διακοπών";
$lang['income_expense_balance_report'] ="Έκθεση Ισοζυγίου Εσόδων Εξόδων";
$lang['income_expense_head'] ="Προϊστάμενος εσόδων εξόδων";
$lang['income_money_in'] ="Εισόδημα Χρήματα σε";
$lang['install'] ="Εγκαθιστώ";
$lang['institute']="Ινστιτούτο";
$lang['location']="Τοποθεσία";
$lang['no_discount_available'] ="Δεν υπάρχει έκπτωση";
$lang['number_of_use_count'] ="Αριθμός χρήσης";
$lang['other_details']="Άλλες λεπτομέρειες";
$lang['overall_balance'] ="Συνολικό Ισοζύγιο";
$lang['partial_payment'] ="Μερική πληρωμή";
$lang['pay_id'] ="Ταυτότητα πληρωμής";
$lang['paying_amount'] ="Ποσό πληρωμής";
$lang['per_day'] ="Ανά ημέρα";
$lang['permission_updated_successfully'] ="Η άδεια ενημερώθηκε με επιτυχία";
$lang['personal_details'] ="Προσωπικά Στοιχεία";
$lang['please_add_at_least_one_row']="Προσθέστε τουλάχιστον μία σειρά";
$lang['profession']="Επάγγελμα";
$lang['reference']="Αναφορά";
$lang['relation']="Σχέση";
$lang['send_by']="Αποστολή Έως";
$lang['skill_category']="Κατηγορία δεξιοτήτων";
$lang['somthing_went_wrong'] ="Κάτι πήγε στραβά";
$lang['staff_absent_attendence'] ="Απουσία Προσωπικού Παρουσία";
$lang['staff_approved_leave']="Εγκεκριμένη άδεια προσωπικού";
$lang['staff_attendance_setting']="Ρύθμιση προσέλευσης προσωπικού";
$lang['staff_present_attendence'] ="Προσωπικό Παρούσα Παρουσία";
$lang['student_approved_leave']="Εγκεκριμένη Άδεια Φοιτητή";
$lang['student_attendance_setting']="Ρύθμιση Παρακολούθησης Φοιτητών";
$lang['student_cv']="Βιογραφικό μαθητή";
$lang['student_guardian_panel_fees_discount'] ="Έκπτωση στα δίδακτρα φοιτητών/κηδεμόνων";
$lang['student_head_count']="Καταμέτρηση κεφαλαίων μαθητών";
$lang['student_panel_cv_setting']="Ρύθμιση βιογραφικού πίνακα μαθητών";
$lang['student_parent_login'] ="Είσοδος μαθητή/γονέα";
$lang['student_present_attendence'] ="Παρουσία Φοιτητών";
$lang['student_profile_setting']="Ρύθμιση προφίλ μαθητή";
$lang['table'] ="Τραπέζι";
$lang['technical_skills'] ="Τεχνικές Δεξιότητες";
$lang['this_action_is_irreversible_so_please_confirm_this_action'] ="Αυτή η ενέργεια είναι μη αναστρέψιμη, επομένως επιβεβαιώστε αυτήν την ενέργεια!";
$lang['this_guardian_email_is_already_exists_for_an_existing_student_and_their_siblings_guardian_email_if_this_student_is_also_sibling_then_add_as_sibling'] ="Αυτό το email κηδεμόνα υπάρχει ήδη για έναν υπάρχοντα μαθητή και το email κηδεμόνα των αδελφών του, εάν αυτός ο μαθητής είναι επίσης αδερφός, προσθέστε ως αδερφό";
$lang['this_guardian_phone_is_already_exists_for_an_existing_student_and_their_siblings_guardian_phone_if_this_student_is_also_sibling_then_add_as_sibling'] ="Αυτό το τηλέφωνο κηδεμόνα υπάρχει ήδη για έναν υπάρχοντα μαθητή και το τηλέφωνο κηδεμόνα των αδελφών του, εάν αυτός ο μαθητής είναι επίσης αδερφός, προσθέστε ως αδερφό";
$lang['total_hour']="Συνολική ώρα";
$lang['total_overdue'] ="Συνολικά ληξιπρόθεσμα";
$lang['transaction_description'] ="Περιγραφή συναλλαγής";
$lang['unistall'] ="Unistall";
$lang['university']="Πανεπιστήμιο";
$lang['update'] ="Εκσυγχρονίζω";
$lang['update_your_addon'] ="Ενημερώστε το πρόσθετό σας";
$lang['upload_your_addon'] ="Ανεβάστε το πρόσθετό σας";
$lang['vacation']="Διακοπές";
$lang['value'] ="Αξία";
$lang['welcome_student']="Καλώς ορίσατε Μαθητής";
$lang['whatsapp_link'] ="Σύνδεσμος Whatsapp";
$lang['whatsapp_settings'] ="Ρυθμίσεις Whatsapp";
